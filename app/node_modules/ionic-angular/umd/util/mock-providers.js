...
(function (factory) {
    ...
    function mockNavController() {
        ...
        var /** @type {?} */ nav = new nav_controller_base_1.NavControllerBase(null, app, config, platform, keyboard, elementRef, zone, renderer, componentFactoryResolver, gestureCtrl, trnsCtrl, linker, dom);
    ...
    function mockOverlayPortal(app, config, plt) {
        ...
        var /** @type {?} */ location = mockLocation();
        var /** @type {?} */ deepLinker = new deep_linker_1.DeepLinker(app, serializer, location);
    ...
    function mockTab(parentTabs) {
        ...
        var /** @type {?} */ gestureCtrl = new gesture_controller_1.GestureController(app);
        var /** @type {?} */ linker = mockDeepLinker(null, app);
        var /** @type {?} */ tab = new tab_1.Tab(parentTabs, app, config, platform, keyboard, elementRef, zone, renderer, compiler, changeDetectorRef, gestureCtrl, null, linker, dom);
    ...
    function mockMenu() {
        ...
        var /** @type {?} */ elementRef = mockElementRef();
        var /** @type {?} */ renderer = mockRenderer();
        return new menu_1.Menu(null, elementRef, null, null, renderer, null, null, gestureCtrl, dom, app);
    }
