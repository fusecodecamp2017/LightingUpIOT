...
export const /** @type {?} */ DATETIME_VALUE_ACCESSOR = {
    ...
    generate() {
        ...
        if (isPresent(template)) {
            ...
            parseTemplate(template).forEach(format => {
                ...
                var /** @type {?} */ optValue = getValueFromFormat(this._value, format);
                var /** @type {?} */ selectedIndex = column.options.findIndex(opt => opt.value === optValue);
                if (selectedIndex >= 0) {
